...
import { limparUltimaCampanha } from "@/lib/ultimaCampanha";
...
/**
 * Tela de campanhas: grade unica de campanhas com filtro de marca.
...
export default function Campanhas() {
  ...
  // Esta e a lista: e o ultimo lugar visto na secao de campanhas, entao limpa a
  // memoria de "ultima campanha" para o menu "Campanhas" voltar para a lista.
  useEffect(() => {
    limparUltimaCampanha();
  }, []);
